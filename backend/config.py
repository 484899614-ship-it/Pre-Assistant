...
class Settings(BaseSettings):
    ...
    # LLM defaults
    default_llm_provider: Literal["openai", "deepseek", "doubao", "anthropic"] = "doubao"
    default_llm_model: str = "doubao-seed-2-0-lite-260215"
    ...
    max_upload_bytes: int = 64 * 1024 * 1024  # 64 MB
