...
- **Source evidence**: For key claims and data, include a source reference in the format `[来源: "brief quote or section reference"]` so speaker notes can trace back to the original text
